...
\begin{itemize}
	...
	\item[] $\mathbb{N} = \{ 1, 2, 3, 4, ... \}$\footnote{perceba que, para o autor do livro, $0 \notin \mathbb{N}$. Usaremos $\mathbb{N}^0$ para expressar os naturais com o elemento 0.}\footnote{\href{https://www.youtube.com/watch?v=j9WmXliT0lM}{Aqui um video bacana sobre o assunto.}}. Conjunto dos Naturais
...
\begin{demonstration}[Division Algorithm]
