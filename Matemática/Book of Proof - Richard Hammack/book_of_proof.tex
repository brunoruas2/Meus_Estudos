...
\\
\\
Usando o princípio da multiplicação você é capaz de resolver todos os problemas envolvendo contagens de listas sem precisar construir as possíveis soluções e sim apenas usando multiplicação. Existem diferenças entre os casos onde temos repetição permitida e em casos de listas não repetitivas. Essas diferenças estão na quantidade de entradas possíveis para cada posição da lista.
\\
\\
