...
def melhor_a(pb_left):
	...
	while i < 1.01:
		...
		result = (50*pa_up*pb_left) + (90*pa_down*pb_left) + (80*pa_up*pb_right) + (20*pa_down*pb_right)
...
ax.set_title('cap 30.4 - Pênalti')
ax.set_xlabel('Artilheiro - Prob Esquerda')
ax.set_ylabel('Goleiro - Prob Esquerda')
...
plt.plot(resultado_a, q2,'-',color='blue', label='Melhor Resp Artilheiro',linewidth=4)
plt.plot(q1, resultado_b,'-',color='red', label='Melhor Resp Goleiro',linewidth=4)
