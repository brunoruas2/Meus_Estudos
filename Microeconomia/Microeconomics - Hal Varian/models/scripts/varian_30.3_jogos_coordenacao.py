...
def melhor_a(pb_left):
	...
	while i < 1.01:
		...
		result = (0*pa_up*pb_left) + (1*pa_down*pb_left) + (-1*pa_up*pb_right) + (-2*pa_down*pb_right)
...
ax.set_title('cap 30.3 - Roleta Russa')
ax.set_xlabel('Linha - Prob Desvia')
ax.set_ylabel('Coluna - Prob Desvia')
