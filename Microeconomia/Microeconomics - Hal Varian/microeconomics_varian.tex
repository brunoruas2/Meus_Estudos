...
\\~\\
A única maneira da soma das demandas líquidas ser igual à zero é o caso onde o valor das demandas líquidas de cada agente é igual a zero.\footnote{Eu demorei um tempo até entender essa frase. Só segue a diante se realmente tu entender.}
\\~\\
