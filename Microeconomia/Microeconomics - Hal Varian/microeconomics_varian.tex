...
\\
\\
De maneira análoga, podemos ver que os ganhos do jogador $coluna$ são iguais a 
...
\\
\\
Com base nessas informações, podemos construir as funções de resposta no gráfico abaixo.
