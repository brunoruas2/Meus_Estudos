...
\\
\\
\textbf{Simulação:} \href{https://colab.research.google.com/drive/1OUK3Z--dv7WMufCLmJ9qDWII1yoVlWVX?usp=sharing}{Clique aqui} para ter acesso a essa simulação do modelo. Você pode mudar os parâmetros de "$a$", "$b$", "CF"\ e "CV"\ afim de verificar como os valores se modificam.
...
\textbf{Simulação:} \href{https://colab.research.google.com/drive/1MRJb9DZ7n_Hz2Kp9ng8K7pOcb1DTy_u5?usp=sharing}{Clique aqui} para ter acesso a essa simulação do modelo.
\\
\\
...
\begin{center}
\includegraphics[scale=0.8]{25_4-inef_monopolio.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.8]{25_5-onus_monopolio.png}
\end{center}
