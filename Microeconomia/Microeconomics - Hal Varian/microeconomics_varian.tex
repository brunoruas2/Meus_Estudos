...
Chegamos exatamente na lei de Walras. Que é o que queríamos mostrar. Como o valor das demandas líquidas de cada agente é igual a zero. A soma das demandas líquidas também será igual a zero.\footnote{Eu demorei um tempo até entender essa frase. Só segue a diante se realmente tu entender.}
\\
\\
...
Agora, basta aplicarmos a lei de Walras ($p_1z_1(p_1,p_2) + p_2z_2(p_1,p_2) = 0$ e resolvermos a equação para $p_1$. O preço de equilíbrio encontrado é igual a
