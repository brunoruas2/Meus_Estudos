...
Partindo de prefências convexas, nossos modelos trabalharam com a hipótese que cada consumidor se preocupa apenas com a cesta de bens. Vamos expandir esse conceito para adicionar que, a partir de agora, os consumidores também possuem preferências sobre a alocação de bens entre os consumidores do mercado. Mesmo que, para alguns, essa preferência seja igual a zero (o que volta para o caso trabalhado anteriormente).
