...
\\
\\
Imaginemos que as empresas suponham que a produção do seu concorrente será uma quantidade qualquer diferente do equilíbrio. Para facilitar, vamos supor que a cesta inicial produzida esteja em cima da curva de reação da empresa 2. A cesta inicial será igual à lista $(y_1^t,y_2^t)$.
\\
\\
...
\\
\\
Esse processo fica se realimentando até um ponto onde elas estão satisfeitas. Esse é justamente o ponto de equilíbrio de Cournot!
\\
\\
A imagem abaixo mostra esse caminho. Mas eu também transformei ela em um gif animado (e bem humorado) para ilustrar o caminho até o equilíbrio.
