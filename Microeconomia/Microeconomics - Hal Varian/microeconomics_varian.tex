...
\textbf{Comentário:} Eu fui infeliz quando fiz essa imagem acima\footnote{Eu vou refazer em algum momento.}. Se você olhar no livro do Varian, perceberá que a caixa de Edgeworth está dentro da FPP e não o contrário. Pelo o que vimos até agora, sabemos que o ponto otimizador será algum ponto onde a TMT = TMS = Isolucro mais alta. Isso nos diz que a sociedade alocará sua força produtiva de modo a não trabalhar com capacidade ociosa. Essa busca por maximizar os recursos define o ``tamanho'' da nossa caixa de Edgeworth. Os agentes trocarão, \textbf{partindo das dotações}, até o ponto onde haja o máximo de Pareto.
