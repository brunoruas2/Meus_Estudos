...
Percebeu que nesse arranjo não temos nenhuma estratégia dominante? O que cada jogador fará, depende da escolha do outro jogador. Um \textbf{equilíbrio de Nash} é criado sempre que a escolha de um jogador for $ótima$ dada a escolha do outro jogador.
\\
\\
...
\\
\\
Vamos pegar esse jogo e simular todas os retornos para cada escolha de probabilidades. Lembre-se que, se a probabilidade de $A$ escolher $alto$ for de $10\%$, então, $baixo$ terá obrigatoriamente de ter a probabilidade igual a $90\%$.
