...
\\
\\
Veja um exemplo da caixa de Edgeworth abaixo. Foram usadas funções de utilidade são cobb-douglas com os coeficientes iguais a $0.5$.
...
\\
\\
No ponto da imagem, temos o encontro de duas curvas de indiferenças, mas os níveis de utilidade são diferentes para cada consumidor. O consumidor A gostaria de abrir mão do bem 1 para poder consumir mais do bem 2, já no caso de B, ele é indiferente quanto a mudança para qualquer alocação que esteja na mesma curva de indiferença. Toda a área entre a curva vermelha no valor de 30 e a azul no valor de 50, representa uma região de melhoria mútua.
\\
\\
