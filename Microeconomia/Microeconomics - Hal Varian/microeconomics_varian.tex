...
Partindo de prefências convexas, nossos modelos trabalharam com a hipótese que cada consumidor se preocupa apenas com a sua própria cesta de bens. Vamos expandir esse conceito para adicionar que, a partir de agora, os consumidores também possuem preferências sobre a alocação de bens entre os consumidores do mercado. Mesmo que ainda seja possível que existam pessoas cujas preferências em relação às alocações das outras pessoas sejam iguais a zero (o que volta para o caso trabalhado anteriormente).
\\
\\
