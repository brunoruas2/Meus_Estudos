...
\\~\\
Seja $w_1$ e $w_2$ a riqueza de cada agente, $g_1$ e $g_2$ são as parcelas de contribuição de cada um deles para o valor ta TV e $x_1$ $x_2$ é a quantia que sobrará para o restante do consumo de cada um deles. Desse modo, podemos representar as restrições como
