...
\begin{center}
\includegraphics[scale=0.4]{cap25_6-monopolio_natural.png}
\end{center}
...
\\
\\
No livro o professor mostra uma situação onde a curva de custo marginal está em um formato que impossibilita o monopolista de vender até mesmo a quantidade que iguala o custo marginal à sua receita marginal. Nesses casos, ele vai operar em um ponto de produção ainda mais reduzido: o ponto onde a curva de custo médio é igual à de demanda.
