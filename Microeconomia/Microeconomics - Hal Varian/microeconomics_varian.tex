...
Quando aplicamos o método de trocas ao problema da justiça, podemos ver que, em uma alocação inicial equitativa, o mecanismo de mercado produz uma alocação final justa. Na imagem acima comparamos duas cestas hipotéticas sendo uma fruto de uma troca por qualquer outra forma de alocação e a cesta justa sendo a resultante das trocas por mecanismo de mercado. Podemos ver que o mecanismo de mercado produz uma alocação final que não é, necessariamente, igualitária mas é, por ser um ótimo de Pareto, uma alocação equitativa e, portanto, justa.
