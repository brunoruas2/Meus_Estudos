...
Não é difícil ver que essa função função de primeiro grau é uma curva de \textbf{isolucro}. Desse modo, podemos ver, a partir de uma nível inicial de lucro $\pi^*$, a quantidade de cocos que manteria o lucro constante após o pagamento da mão de obra.
\\
\\
