...
\\
\\
Podemos agora ir um pouco mais adiante: todos máximo de bem-estar são equilíbrios competitivos e todos os equilíbrios competitivos são o máximo de bem-estar de alguma função de bem-estar.
...
\\
\\
Uma abordagem, chamada de \textbf{estudo das alocações justas}, tenta analisar os pontos de equilíbrio a aprtir de alguns julgamentos morais específicos e suas implicações.
\\
\\
Se dividirmos $n$ bens igualmente entre três pessoas, A, B e C. A e C possuem as mesmas preferências. Se você usar o princípio moral da igualdade, as alocações iniciais de cada pessoa serão $n/3$. Mas como elas são diferentes em preferências, haverá o incentivo de trocas. Se A e B fazem uma troca, teremos um aumento do bem-estar social que nos leva a um ótimo de Pareto. Mas C não teve a chance de trocar com ninguém e, nesse caso, pode \textbf{invejar} a pessoa A.
\\
\\
