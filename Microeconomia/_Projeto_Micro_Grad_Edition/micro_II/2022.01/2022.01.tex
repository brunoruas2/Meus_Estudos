...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Nesse primeiro momento, usaremos o sistema de trocas puras.
	\end{itemize}
...
\begin{frame}
	...
	\\~\\
	Um par de cestas será chamado de \textbf{alocação}. Esse par indica a condição inicial de cada agente e é denotado por $W_A = (w_A^1,w_A^2)$ e $W_B = (w_B^1,w_B^2)$.
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\colorbox{black}{\includegraphics[scale=0.5]{cap32_1-caixa_edgeworth_1.png}}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\colorbox{black}{\includegraphics[scale=0.5]{cap32_1-caixa_edgeworth_2.png}}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}[H]
		\centering
		\colorbox{black}{\includegraphics[scale=0.5]{cap32_11-caixa_edgeworth_1.png}}
	\end{figure}
